...
void split_cljp(CSRMatrix* S, std::vector<int>& states, const double* rand_vals = nullptr);
void split_pmis(CSRMatrix* S, std::vector<int>& states, const double* rand_vals = nullptr);
